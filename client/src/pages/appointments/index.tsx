...
import { Calendar, Search, Filter, Plus, Check, X, Clock, ChevronLeft, ChevronRight } from "lucide-react";
...
const Appointments = () => {
  ...
  const getFilteredAppointments = () => {
    ...
    switch (selectedTab) {
      ...
      case "completed":
        return filtered.filter(appointment => appointment.status === "completed");
      case "cancelled":
        return filtered.filter(appointment => 
        ...
        {dates.map((date) => {
          ...
          return (
            ...
            >
              ...
              <span className={`text-lg font-medium ${isToday && !isSelected ? 'text-primary' : ''}`}>
                {date.getDate()}
              </span>
            </button>
          );
    ...
    <div className="p-4 lg:p-6">
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Gerencie todos os agendamentos da clínica</p>
        </div>
                    ...
                    {getFilteredAppointments().map((appointment) => (
                      <tr key={appointment.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-4 whitespace-nowrap">
                          ...
                          <div className="text-xs text-gray-500">{appointment.professional.name}</div>
                        </td>
                        <td className="px-4 py-4 whitespace-nowrap">
