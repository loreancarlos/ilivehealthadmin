      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <div className="flex justify-center mb-6">
            ...
            <span className="ml-2 text-xs font-medium bg-gray-100 text-gray-600 px-2 py-0.5 rounded self-start">ADMIN</span>
          </div>
          <CardTitle className="text-2xl font-bold">Faça login na sua conta</CardTitle>
          <CardDescription>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button variant="link" className="p-0 h-auto text-sm font-medium text-primary" disabled={isLoading}>
                  Esqueceu a senha?
                </Button>
              </div>
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-gray-600">
            Precisa de ajuda? <a href="mailto:suporte@ilivehealth.com" className="font-medium text-primary hover:underline">Contate o suporte</a>
          </p>
        </CardFooter>
      </Card>
    </div>
