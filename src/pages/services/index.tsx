...
import { Search, Filter, Plus, Edit, Trash2, ToggleRight, Tag, Clock } from "lucide-react";
    ...
    <div className="p-4 lg:p-6">
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Gerencie os serviços oferecidos pela clínica</p>
        </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: Consulta Dermatológica" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Ex: Convênio, Primeira consulta, Especialidade" {...field} />
                      </FormControl>
                      <FormDescription>
            ...
            <div className="overflow-x-auto bg-white border rounded-lg">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {getFilteredServices().map((service) => (
                    <tr key={service.id} className={!service.active ? "bg-gray-50" : "hover:bg-gray-50"}>
                      ...
                      <td className="px-4 py-4">
                        <div className="text-sm text-gray-900">{getCategoryName(service.category)}</div>
                      </td>
                      <td className="px-4 py-4">
